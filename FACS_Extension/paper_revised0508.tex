...
\begin{algorithm}[t]
    ...
    \begin{algorithmic}[1]
        ...
        \STATE absGlobalConstr = None %\% to store all constraints under P
        \STATE absTimeConstr = None %\% to store all timed constraints under P
...
\centering
\begin{tikzpicture}
	\node (note1) at (5.1, -2.6) {\small (a) Sequencer};
    \node (note2) at (11.5, -2.6) {\small (b) Variant Sequencer};
    \node (note3) at (4.25,-1.1) {e};
    \node (note3) at (10.75,-1.1) {e};

    \ionode{(inup)}{(3.5, 0.8)}{node[left] {A}}
    \ionode{(indown)}{(3.5, 0)}{node[left] {B}}
    \ionode{(out)}{(7.7,0.8)}{node[right] {C}}
    \mixednode{(mid1up)}{(6.5, 0.8)}{node[above] {D}}
    \mixednode{(mid1down)}{(5, 0)}{node[above] {E}}
    \mixednode{(mid2left)}{(3.5, -1.1)}{node[left] {F}}
    \mixednode{(mid2mid)}{(5, -1.1)}{node[below] {G}}
    \mixednode{(mid2right)}{(6.5, -1.1)}{node[right] {H}}
    \sync{(inup)}{(mid1up)}{}
    \sync{(mid1up)}{(out)}{}
    \sync{(indown)}{(mid1down)}{}
    \draw [-](5,0) -- (6.8,0)node[below]{};
    \draw [->](6.8,0) -- (7.6,0.7)node[below]{};
    \syncdrain{(mid1down)}{(mid2mid)}{}
    \syncdrain{(mid1up)}{(mid2right)}{}
    \fifoe{(mid2left)}{(mid2mid)}{}
    \fifoe{(mid2mid)}{(mid2right)}{}
    \draw [-](6.5,-1.1) -- (6.5,-1.8)node[below]{};
    \draw [-](6.5,-1.8) -- (3.5,-1.8)node[below]{};
    \draw [->](3.5,-1.8) -- (3.5,-1.2)node[below]{};

    \ionode{(pinup)}{(10, 0.8)}{node[left] {A}}
    \ionode{(pindown)}{(10, 0)}{node[left] {B}}
    \ionode{(pout)}{(14.2,0.8)}{node[right] {C}}
    \mixednode{(pmid1up)}{(13, 0.8)}{node[above] {D}}
    \mixednode{(pmid1down)}{(11.5, 0)}{node[above] {E}}
    \mixednode{(pmid2left)}{(10, -1.1)}{node[left] {F}}
    \mixednode{(pmid2mid)}{(11.5, -1.1)}{node[below] {G}}
    \mixednode{(pmid2right)}{(13, -1.1)}{node[right] {H}}
    \sync{(pinup)}{(pmid1up)}{}
    \lossysync{(pmid1up)}{(pout)}{}
    \sync{(pindown)}{(pmid1down)}{}
    \draw [dashed](11.5,0) -- (13.3,0)node[below]{};
    \draw [dashed](13.3,0) -- (14,0.7)node[below]{};
    \draw [->](13.9,0.6) -- (14,0.7)node[below]{};
    \syncdrain{(pmid1down)}{(pmid2mid)}{}
    \syncdrain{(pmid1up)}{(pmid2right)}{}
    \fifoe{(pmid2left)}{(pmid2mid)}{}
    \fifoe{(pmid2mid)}{(pmid2right)}{}
    \draw [-](13,-1.1) -- (13,-1.8)node[below]{};
    \draw [-](13,-1.8) -- (10,-1.8)node[below]{};
    \draw [->](10,-1.8) -- (10,-1.2)node[below]{};
    \end{tikzpicture}
\caption{Example of connector complementary refinement }
\label{fig:large}
\end{figure}
