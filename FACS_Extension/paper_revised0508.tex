...
%\maketitle
\begin{abstract}
Reo is a channel-based exogenous coordination language in which complex coordinators, called connectors, are compositionally built out of simpler ones. In this paper, we present an approach to model and reason about connectors using Coq and Z3. %Coq is a proof assistant based on higher-order logic and $\lambda$-calculus.
...
%The proof of Theorem \ref{the:alternator} for the connector in Fig. \ref{fig:alternator}(a) can be used to simplify the proof for the following property of alternator.
...
\centering
\begin{tikzpicture}
	\node (note1) at (4.1, -2.6) {\small (a) Connector P};
    \node (note2) at (10.5, -2.6) {\small (b)Variant Connector Q};
